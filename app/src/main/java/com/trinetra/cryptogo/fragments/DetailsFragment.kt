...
import com.trinetra.cryptogo.databinding.FragmentDetailsBinding
...
class DetailsFragment : Fragment() {
    ...
    private fun setButtonOnClick(item: CryptoCurrency) {
        ...
        fifteenMinute.setOnClickListener(clickLister)
        oneHour.setOnClickListener(clickLister)
        fourHour.setOnClickListener(clickLister)
        oneDay.setOnClickListener(clickLister)
        oneWeek.setOnClickListener(clickLister)
        oneMonth.setOnClickListener(clickLister)
    }
